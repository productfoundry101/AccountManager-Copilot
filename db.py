...
TABLES = {
    "accounts":      {"snapshot": "accounts",      "live": "HUMBL.CRM.ACCOUNTS"},
    "contacts":      {"snapshot": "contacts",      "live": "HUMBL.CRM.CONTACTS"},
    "opportunities": {"snapshot": "opportunities", "live": "HUMBL.CRM.OPPORTUNITIES"},
    "activities":    {"snapshot": "activities",    "live": "HUMBL.CRM.ACTIVITIES"},
    "usage":         {"snapshot": "usage_data",    "live": "HUMBL.PRODUCT.USAGE"},
    "tickets":       {"snapshot": "tickets",       "live": "HUMBL.SUPPORT.TICKETS"},
}
