...
CASES = [
    ...
    },
    {
        ...
        "required_any": [["Cascade"], ["215"], ["Keystone"]],
    ...
    {
        "id": "bloom_cheaper_specific",
        "ae": "lena.koehler@humbl.de",
        "question": 'a customer says "Bloom is cheaper". what do I say?',
        "must_call": ["read_knowledge_doc"],
