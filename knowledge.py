...
DOCS = {
    "sales_playbook": (
        ...
        "How Humbl sells: MEDDIC qualification, deal stages with exit "
    ...
    "battlecard_keystone": (
        "03_battlecard_keystone.md",
        "Competing against Keystone: when we win/lose, their pitch, our "
        "counters, objection talk tracks, red-flag combinations",
    ),
    "battlecard_bloom": (
        "04_battlecard_bloom.md",
        "Competing against Bloom: when we win/lose, their pitch, our "
